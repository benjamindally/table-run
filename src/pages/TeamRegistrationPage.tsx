...
const TeamRegistrationPage: React.FC = () => {
  ...
  const validateStep = (step: number) => {
    ...
    if (step === 1) {
      ...
      if (!formData.captain.name)
        newErrors["captain.name"] = "Captain name is required";
      if (!formData.captain.phone)
        newErrors["captain.phone"] = "Captain phone is required";
      if (
        formData.captain.email &&
        !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.captain.email)
      ) {
          ...
          {currentStep === 1 && (
            <div className="space-y-6 slide-in">
              ...
              <div className="form-group">
                <label htmlFor="establishmentName" className="form-label">
                  Establishment Name *
                </label>
                <input
                  type="text"
                  ...
                  onChange={(e) =>
                    updateFormData("establishmentName", e.target.value)
                  }
                />
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateFormData("numberOfTables", parseInt(e.target.value))
                  }
                >
            ...
            <div className="space-y-6 slide-in">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  id="captainName"
                  className={`form-input ${
                    errors["captain.name"] ? "border-red-500" : ""
                  }`}
              ...
              <div className="form-group">
                <label htmlFor="captainPhone" className="form-label">
                  Captain Phone *
                </label>
                <input
                  type="tel"
                  id="captainPhone"
                  className={`form-input ${
                    errors["captain.phone"] ? "border-red-500" : ""
                  }`}
              ...
              <div className="form-group">
                <label htmlFor="captainEmail" className="form-label">
                  Captain Email
                </label>
                <input
                  type="email"
                  id="captainEmail"
                  className={`form-input ${
                    errors["captain.email"] ? "border-red-500" : ""
                  }`}
              ...
              <div className="bg-gray-50 p-4 rounded-md">
                <h3 className="text-lg font-semibold mb-3">
                  Player Representative (Optional)
                </h3>
                <p className="text-sm text-gray-600 mb-3">
                  The player representative assists the captain with team
                  management.
                </p>

                <div className="form-group">
                  <label htmlFor="playerRepName" className="form-label">
                    Player Rep Name
                  </label>
                  <input
                    type="text"
                    id="playerRepName"
                    className={`form-input ${
                      errors["playerRep.name"] ? "border-red-500" : ""
                    }`}
                ...
                <div className="form-group mb-0">
                  <label htmlFor="playerRepPhone" className="form-label">
                    Player Rep Phone
                  </label>
                  <input
                    type="tel"
                    id="playerRepPhone"
                    className={`form-input ${
                      errors["playerRep.phone"] ? "border-red-500" : ""
                    }`}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium">
                      Team Captain (Already Added)
                    </h3>
                    <p className="text-sm text-gray-600">
                      {formData.captain.name} • {formData.captain.phone}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-3">
              Team registration is subject to approval by league oeprators.
            </p>
            <p className="text-sm text-gray-600">
              For questions or assistance with registration, please contact us
              at
              <a
                href="mailto:contact@leaguegenius.com"
                className="text-primary ml-1"
              >
                contact@leaguegenius.com
              </a>
              .
            </p>
          </div>
