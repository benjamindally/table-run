  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        sans: ['Antonio_400Regular'],
        thin: ['Antonio_100Thin'],
        extralight: ['Antonio_200ExtraLight'],
        light: ['Antonio_300Light'],
        normal: ['Antonio_400Regular'],
        medium: ['Antonio_500Medium'],
        semibold: ['Antonio_600SemiBold'],
        bold: ['Antonio_700Bold'],
      },
      fontSize: {
        // Increased all sizes by 2px from Tailwind defaults
        xs: '14px',    // was 12px
        sm: '16px',    // was 14px
        base: '18px',  // was 16px
        lg: '20px',    // was 18px
      ...
      colors: {
        ...
        // Secondary: Mustard Yellow - Alternative actions, highlights
        secondary: {
          DEFAULT: '#FBC02D',
          50: '#FFFDE7',
          100: '#FFF9C4',
