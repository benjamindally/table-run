...
const LeagueDetailsPage: React.FC = () => {
  ...
  /* 
    ! TODO: use the new is_public value on league and incorporate logic therof
  */

  // Check if user is a league operator for this specific league
  const isOperator =
    myLeaguesData?.results?.some((l) => l.id === leagueId) ?? false;
          ...
          {isOperator ? (
            ...
            <div className="pt-4 border-t">
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-sm text-gray-600">
                You are viewing this league in read-only mode. Only league
                operators can edit league details.
              </div>
            </div>
          )}
        </form>
      ...
      >
        <div className="space-y-4">
          <p className="text-dark">
            Are you sure you want to delete this league? This action is{" "}
            <strong>irreversible</strong> and will permanently delete all
            associated data including seasons, matches, and statistics.
          </p>
